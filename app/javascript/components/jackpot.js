...
const playJackpot = () => {
  ...
  const round = (dice1, dice2, totalDices) => {
    ...
    if(el){
      ...
      document.getElementById('dice1').src = "http://jackpotjs.herokuapp/app/assets/images/dice-" + dice1 + ".png";
      document.getElementById('dice2').src = "http://jackpotjs.herokuapp/app/assets/images/dice-" + dice2 + ".png";
      // disabled btn-roll
    ...
    const reset = () => {
      ...
      document.getElementById('dice1').src = 'htttp://jackpotjs.herokuapp/app/assets/images/dice-1.png';
      document.getElementById('dice2').src = 'htttp://jackpotjs.herokuapp/app/assets/images/dice-1.png';
      // Reset Roll button
      document.getElementById('btn-roll').removeAttribute('disabled', '');
    }
    // gameOver function
