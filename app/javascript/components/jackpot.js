  ...
  const round = (dice1, dice2, totalDices) => {
    ...
    if(el){
      el.addEventListener('click', () => {
        ...
        document.getElementById('dice1').src = 'https://res.cloudinary.com/bessiere/image/upload/v1599140242/dice-' + dice1 + '.png';
        document.getElementById('dice2').src = 'https://res.cloudinary.com/bessiere/image/upload/v1599140242/dice-' + dice2 + '.png';
        // disabled btn-roll
    ...
    const reset = () => {
      ...
      document.getElementById('dice1').src = 'https://res.cloudinary.com/bessiere/image/upload/v1599140242/dice-6.png';
      document.getElementById('dice2').src = 'https://res.cloudinary.com/bessiere/image/upload/v1599140242/dice-6.png';
      // Reset Roll button
      document.getElementById('btn-roll').removeAttribute('disabled', '');
    }
    // gameOver function
